...
jQuery(document).ready(function(){
  ...
  tipStyle();
  //单独弹出一个编辑窗口
  jQuery("a[dialog_uri],input[dialog_uri],dt[dialog_uri]").on("click",null,function(e){
	...
	jQuery("#"+dialog_id).remove();
	 if(dialog_uri!="undefined"){
	   ...
	   if(dialog_top==undefined||dialog_top==""){
		   ...
		   dialog_top = (_windowHeight - dialog_height)/2 + _scrollHeight;
	   }else{
  ...
  jQuery("a[ck_dialog_uri],input[ck_dialog_uri],dt[ck_dialog_uri]").on("click",null,function(e){
      var mulitId="";
