...
<#assign P_NAV2="商品" />
<#assign P_NAV3="违规下架的商品" />
<#assign P_CURRENT_OP="GoodsOut" />
                  ...
                  <div class="productmain" style="width: 910px;">
                      ...
                      <div class="alldel">
                          ...
                          <div class="alldel_l">
                              ...
                              <span class="alldel_lb">全选
                                  <input name="mulitId" type="hidden" id="mulitId" />
                                  <input name="op" type="hidden" id="op" value="storage" />
                              </span>
                              <span class="alldel_lc">
                                  <a href="javascript:void(0);" onclick="cmd('${S_URL}/goods/goods_del','')" class="button_common">删除</a>
                              </span>
                          </div>
                      </div>
                      <div class="operation">
                          <table width="900" border="0" cellspacing="0" cellpadding="0" id="opertable" >
                              <tr id="opertitle">
                                  ...
                                  <td width="172" align="center">操作</td>
                              </tr>
                              <#list objs! as obj >
                                  <tr class="opertr">
                                      ...
                                      <td class="operajt">
                                          ...
                                          <span class="del">
                                              <a href="javascript:if(confirm('删除后不可恢复?'))window.location.href='${S_URL}/goods/goods_del?mulitId=${(obj.id)!}&op=out'">删除</a>
                                          </span>
                                      </td>
                                  </tr>
                              </#list>
