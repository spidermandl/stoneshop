...
<#assign P_NAV2="商品" />
<#assign P_NAV3="出售中的商品" />
<#assign P_CURRENT_OP="GoodsForSell" />
    ...
    <div class="ncsc-layout-right" id="layoutRight">
      ...
      <div id="mainContent" class="main-content">
        <@shiro.hasPermission name="seller:read">
            <form action="${S_URL}/goods/forsell_list" method="post" name="ListForm" id="ListForm">
                    ...
                    <div class="alldel">
                        ...
                        <div class="alldel_l">
                            ...
                            <span class="alldel_ld">
                                <a class="button_common" href="javascript:void(0);" onclick="cmd('${S_URL}/goods/goods_sale','')">下架</a>
                            </span>
                        </div>
                    </div>
                    <div class="operation">
