...
public class StoreJoinController {
    ...
    public String stepFour(@CurrentUser User user,StoreJoin storeJoin,
    ...
    public String stepFour(@CurrentUser User user,Model model, HttpServletRequest request,
                           HttpServletResponse response) {
    ...
    public String pay(@CurrentUser User user,Model model, HttpServletRequest request,
                      HttpServletResponse response) {
        StoreJoin storeJoin = storeJoinService.getCurrentUserStoreJoin(user);
    ...
    public String paySave(@CurrentUser User user,
    ...
    public String verify(@CurrentUser User user){
        StoreJoin storeJoin = storeJoinService.getCurrentUserStoreJoin(user);
        if (storeJoin.getJoininState().equals("40")){
            storeJoinService.saveVerify(storeJoin.getMemberId(),"pass",null,null);
            /**
             * 修改用户角色
             */
