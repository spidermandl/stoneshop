package org.goshop.portal.tools;
...
public class IpAddress {
    private String dataPath = "classpath:QQWry.dat";
//            System.getProperty("wemall.root") +
...
//            File.separator + "QQWry.dat";
    ...
    private IpAddress(){
        try {
            ...
            this.ipFile = new RandomAccessFile(ResourceUtils.getFile(dataPath),"r");
