...
public class MemberController {
    ...
    @ResponseBody
    public void baseSave(@CurrentUser User user,MemberModel memberModel,
                        HttpServletRequest request,
                        HttpServletResponse response){
    ...
    @ResponseBody
    public void passwordSave(@CurrentUser User user,String orig_password,
    ...
    public String avatarSave(@CurrentUser User user,Model model,
