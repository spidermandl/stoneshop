...
function order_pay(){
  ...
  if(payType=="wxcodepay"){// 微信扫码支付
  	var html = '';
  	jQuery.get("${S_URL}/wechat/wxcodepay.htm",{"order_id":orderId},function(data){
  		html += data;
              ...
              <ul>
                ...
                <#if (install!false)==true >
                  <div class="bankone">
	                ...
	                </span> <span class="bankimg"><img src="${imageWebServer!}/static/images/common/payment/paypal.jpg" width="125" height="47" /></span>
	                <span class="bank_txt">${content!}</span>
                  </div>
                </#if>
                  <!-- 财付通支付 -->
                ...
                <#if (install!false)==true >
                  <div class="bankone">
                    ...
                    </span> <span class="bankimg"><img src="${imageWebServer!}/static/images/common/payment/tenpay.jpg" width="125" height="47" /></span>
                    <span class="bank_txt">${content!}</span>
                  </div>
                </#if>
                  <!-- 微信扫码支付 -->
                ...
                <#if (install!false)==true >
                  <div class="bankone">
                    ...
                    </span> <span class="bankimg"><img src="${imageWebServer!}/static/images/common/payment/weixin.png" width="125" height="47" /></span>
                    <span class="bank_txt">${content!}</span>
                  </div>
                </#if>
                  <!-- 网银在线支付 -->
                ...
                <#if (install!false)==true >
                  <div class="bankone">
                    ...
                    <span class="bankimg"><img src="${imageWebServer!}/static/images/common/payment/bill.jpg" width="125" height="47" /></span>
                    <span class="bank_txt">${content!}</span>
                  </div>
                </#if>
                  </li>
                ...
                <#if (install!false)==true >
                  <div class="bankone">
                    ...
                    </span> <span class="bankimg"><img src="${imageWebServer!}/static/images/common/payment/outline.jpg" width="125" height="47" /></span>
                    <span class="bank_txt">${content!}</span>
                  </div>
                </#if>
                  </li>
                ...
                <#if (install!false)==true >
                  <div class="bankone">
                    ...
                    <span class="bankimg"><img src="${imageWebServer!}/static/images/common/payment/payafter.jpg" width="125" height="47" /></span>
                    <span class="bank_txt">${content!}</span>
                  </div>
                </#if>
                </li>
                ...
                <#if (install!false)==true >
                  <div class="bankone">
                    ...
                    <span class="bankimg"><img src="${imageWebServer!}/static/images/common/payment/balance.jpg" width="125" height="47" /></span>
                    <span class="bank_txt">${content!}</span>
                  </div>
                </#if>
                </li>
              ...
              <ul>
                ...
                <#if (install!false)==true >
                  <div class="bankone"> <span class="banksp">
                    <input name="payType" type="radio" value="alipay" checked="checked" />
                    </span> <span class="bankimg"><img src="${imageWebServer!}/static/images/common/payment/alipay.jpg" width="125" height="47" /></span>
                ...
                <#if (install!false)==true >
                  ...
                  <input name="payType" type="radio" value="paypal" />
                      ...
                      <span class="bankimg">
                          <img src="${imageWebServer!}/static/images/common/payment/paypal.jpg" width="125" height="47" /></span>
                      <span class="bank_txt">${content!}</span>
                  </div>
                </#if>
                  <!-- 财付通支付 -->
                ...
                <#if (install!false)==true >
                  <div class="bankone">
                      ...
                      <span class="bankimg">
                          <img src="${imageWebServer!}/static/images/common/payment/tenpay.jpg" width="125" height="47" /></span>
                      <span class="bank_txt">${content!}</span> </div>
                </#if>
                  <!-- 微信扫码支付 -->
                ...
                <#if (install!false)==true >
                  <div class="bankone">
                    ...
                    <input name="payType" type="radio" value="wxcodepay" />
                      ...
                      <span class="bankimg">
                          <img src="${imageWebServer!}/static/images/common/payment/weixin.png" width="125" height="47" /></span>
                      <span class="bank_txt">${content!}</span>
                  </div>
                </#if>
                  <!-- 网银在线支付 -->
                ...
                <#if (install!false)==true >
                  <div class="bankone">
                      ...
                      <span class="bankimg"><img src="${imageWebServer!}/static/images/common/payment/chinabank.jpg" width="125" height="47" /></span>
                      <span class="bank_txt">${content!}</span> </div>
                </#if>
                  <!-- 快钱支付 -->
                ...
                <#if (install!false)==true >
                  <div class="bankone">
                      ...
                      <span class="bankimg"><img src="${imageWebServer!}/static/images/common/payment/bill.jpg" width="125" height="47" /></span>
                      <span class="bank_txt">${(obj.content)!}</span> </div>
                </#if>
                </li>
                <li>
                  <h1>线下支付</h1>
                ...
                <#if (install!false)==true >
                  <div class="bankone">
                      ...
                      <span class="bankimg"><img src="${imageWebServer!}/static/images/common/payment/outline.jpg" width="125" height="47" /></span>
                      <span class="bank_txt">${content!}</span> </div>
                </#if>
                   </li>
                   <li>
...
<div style="display:none;" id="pay_overlay">
  <div class="white_content">
  	<a href="javascript:void(0);" onclick="javascript:jQuery('#pay_overlay').hide();" class="white_close">
        <img src="${imageWebServer!}/static/styles/system/front/default/images/close.jpg" width="14" height="14" /></a>
    <div class="white_box">
      <h1>支付提醒</h1>
      <dl class="white_dl">
        <dt></dt>
...
<div style="display:none;" id="wxcodepay_overlay">
  <div class="wx_content">
  	<a href="javascript:void(0);" onclick="javascript:jQuery('#wxcodepay_overlay').hide();" class="white_close">
        <img src="${imageWebServer!}/resources/styles/system/front/default/images/close.jpg" width="14" height="14" /></a>
    <div class="wx_box">
      <h1>微信二维码扫码支付</h1>
      <dl class="wx_dl">
        <dt id="wxPayCode"></dt>
        <dd>
          <div class="payf"><a href="${S_URL}/order_finish?order_id=${(of.id)!}">完成支付！</a></div>
